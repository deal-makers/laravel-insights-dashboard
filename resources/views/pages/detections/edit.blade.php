                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('clients') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('clients[]', $clients, old('clients', isset($detection) ?  array_map('intval', unserialize($detection->client_send_ids)) : []), ['class' => 'form-control', 'data-toggle'=>'select2', 'multiple'=>'multiple']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('tags[]', $tags, old('tags', isset($detection) ?  array_map('intval', unserialize($detection->tags)) : []), ['class' => 'form-control', 'data-toggle'=>'select2', 'multiple'=>'multiple']) !!}
                                    @if($errors->has('tags'))
                                        <div class="mt-1 require_error">
                                            {{ $errors->first('tags') }}
                                        </div>
